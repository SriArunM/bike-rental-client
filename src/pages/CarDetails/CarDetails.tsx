...
export default function CarDetails() {
  ...
  const { tripTime } = useAppSelector(selectLocation) as {
    tripTime: [Date, Date];
  };
  const { id } = useParams();
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-white/80 space-y-2">
                  <li>
                    ...
                    to 12 hours before the rental period starts.
                  </li>
                  <li>
                    <strong>Fuel Policy:</strong> Full tank to full tank. The
                    bike should be returned with the same fuel level as
                    provided.
                  </li>
                  <li>
                    <strong>Mileage Limit:</strong> 100 km per day. Additional
                    kilometers will incur extra charges.
                  </li>
                  <li>
                    <strong>Helmet Policy:</strong> Helmets are mandatory and
                    provided with every rental.
                  </li>
                  <li>
                    <strong>Pillion Rider:</strong> Allowed with appropriate
                    safety gear.
                  </li>
                  <li>
                    <strong>Rider Requirements:</strong> The rider must be at
                    least 18 years old and possess a valid two-wheeler license.
                  </li>
                </ul>
              </div>
