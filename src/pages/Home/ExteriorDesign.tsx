      ...
      <div className="pl-2 md:pl-8 lg:flex-1 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              <h3 className="text-2xl font-bold">Smart, Beautiful Bikes</h3>
              <p className="text-gray-300 w-3/4">
                At BikeRental, our fleet is designed for both comfort and style.
                Choose from a range of high-performance vehicles with modern
                designs.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              ...
              <p className="text-gray-300 w-3/4">
                Wherever your journey takes you, BikeRental ensures you drive
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              ...
              <p className="text-gray-300 w-3/4">
                ...
                bikes are designed for performance and excitement on the road.
              </p>
            </div>
          </div>
        </div>
